...
public class SorterCameraReq {
    private short trackId;
    private String barcode;

    @OpcUaConstructor
    public SorterCameraReq(@OpcUaNode(name = "CAMERA_TID_DATA") short trackId,@OpcUaNode(name = "CAMERA_BARCODE_DATA") String barcode) {
        this.trackId = trackId;
        this.barcode = barcode;
    }

    public SorterCameraReq() {
